...
일반 사용자는 **plaintext DLC 덤프나 파이썬을 준비할 필요가 없습니다.** 먼저 본편 패치가
적용된 상태에서 [v2.8 `culdcept-dlc-korean-v2.8.zip`](https://github.com/snake7594/culdcept-revolt-korean/releases/download/v2.8/culdcept-dlc-korean-v2.8.zip)을
받습니다. v2.8에는 수정된 108개 IPS가 구형 패치와 같은 파일명으로 모두 들어 있어,
...
[v2.8 전체 패키지](https://github.com/snake7594/culdcept-revolt-korean/releases/download/v2.8/culdcept-dlc-korean-v2.8.zip)를
받아 v2.5 DLC 모드 폴더에 병합하세요.
...
v2.8의 `load` 폴더를 Azahar 사용자 폴더에 병합하세요. 적용 후 게임과 에뮬레이터를 완전히 종료하고
...
v2.4/v2.5/v2.6/v2.7/v2.8 ZIP은 **DLC 본체를 포함하거나 설치하지 않습니다.** 본인 소유 DLC가 Azahar
